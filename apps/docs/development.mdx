...
| ---------------- | ---- | ------------------------------------------------------- |
| 🖥️ **Frontend**  | 4100 | [localhost:4100](http://localhost:4100)                 |
| ⚡ **Backend**   | 4101 | [localhost:4101](http://localhost:4101)                 |
| 📚 **API Docs**  | 4101 | [localhost:4101/openapi](http://localhost:4101/openapi) |
| 📖 **Docs Site** | 4102 | [localhost:4102](http://localhost:4102)                 |
