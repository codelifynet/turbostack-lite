...
import type { OrdersStats } from "@repo/types";
...
export function OrdersStatsCards({ stats }: OrdersStatsCardsProps) {
  return (
    <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <Card className="relative overflow-hidden bg-linear-to-br from-amber-500/10 to-yellow-500/5 border-0 shadow-sm hover:shadow-md transition-shadow">
        <div className="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full bg-linear-to-br from-white/5 to-transparent" />
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-sm font-medium text-muted-foreground">
            Pending
