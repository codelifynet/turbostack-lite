	...
	return (
		...
		>
			...
			>
				<defs>
					<linearGradient
						id={`${id}-radial-gradient-${firstDataKey}`}
						x1="0"
						y1="0"
						x2="1"
						y2="1"
					...
					<filter
						id={`${id}-radial-glow-${firstDataKey}`}
						x="-50%"
						y="-50%"
						width="200%"
						height="200%"
				...
				<RadialBar
					...
					cornerRadius={14}
					fill={`url(#${id}-radial-gradient-${firstDataKey})`}
					style={{ filter: `url(#${id}-radial-glow-${firstDataKey})` }}
								...
								if (viewBox && "cx" in viewBox && "cy" in viewBox) {
									return (
										<text
											...
											style={{ filter: `url(#${id}-radial-inner-shadow)` }}
										>
											<tspan
												x={viewBox.cx}
												y={viewBox.cy}
